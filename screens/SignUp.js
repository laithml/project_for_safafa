        ...
        <View style={{ padding: Spacing }}>
          ...
          <View style={{ marginVertical: Spacing }}>
            ...
            <RNPickerSelect
              ...
              items={[
                { label: "1980-01-01", value: "1980-01-01" },
                { label: "1981-01-01", value: "1981-01-01" },
                // Add more birthdate options as needed
              ]}
              style={{
                inputIOS: {
                  borderWidth: 1,
              ...
              onDonePress={handleBirthdateBlur}
            />
