...
export default function SignUp() {
    ...
    const [errorMessagePasswordMatch, setErrorMessagePasswordMatch] = React.useState("");
    ...
    function handleNameBlur(e) {
        ...
        if (fullName.length > maxLength) {
            ...
            setErrorMessageName('Please enter your full name with two names, separated by spaces.');
        } else {
            // name is valid
            setErrorMessageName("");
        }
                ...
                <View style={{marginVertical: Spacing}}>
                    ...
                    <TextInput
                        ...
                        style={{
                            ...
                            padding: Spacing * 2,
                            marginVertical: Spacing,
                            borderColor: errorMessagePassword || errorMessagePasswordMatch ? "red" : Colors.gray,
                        }}
